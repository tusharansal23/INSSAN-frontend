            ...
            <nav className="navbar navbar-expand-lg navbar-light py-0 px-4 navbar-bg-transparent">
                <a href="index.html" className="navbar-brand d-flex align-items-center text-center">
                    <div className="icon p-2 me-2">
                        <img className="img-fluid navbar-img-container" src="img/INSSAN-logo.png" alt="Icon" /*style="width: 30px; height: 30px;"*/ />
                    </div>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div className="navbar-nav ms-auto">
                        ...
                        <a href="glimpses.html" className="nav-item nav-link">Related Sites</a>
